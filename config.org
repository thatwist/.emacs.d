...
(use-package telephone-line
  ...
  (telephone-line-evil-insert ((t (:foreground "#363c34" :background "#f3bff8" :inherit telephone-line-evil))))
  ...
  (telephone-line-accent-active ((t (:foreground "#363c34" :background "#f9d7a8" :inherit telephone-line-evil))))
...
(custom-set-faces '(font-lock-type-face ((t :family "Source Code Pro"
                                            :slant oblique))))
(custom-set-faces '(font-lock-string-face ((t :family "Source Code Pro" :foreground "#999"))))
;; (custom-set-faces '(font-lock-constant-face ((t :family "Source Code Pro" :foreground "#909090"))))
;; (custom-set-faces '(font-lock-function-name-face ((t :family "Source Code Pro" :foreground "#909090"))))


(custom-set-faces '(font-lock-builtin-face ((t (:box t)))))
(custom-set-faces '(font-lock-doc-face ((t (:slant italic
                                                   :family "Source Code Pro" :foreground "#999")))))
(custom-set-faces '(font-lock-comment-face ((t ( :slant italic :weight light
                                                 ;; :height 120
                                                 :width ultra-condensed :foreground "#777"
