...
(if (eq system-type 'windows-nt)
    (set-face-attribute 'default nil :font "Fira Mono" :height 121) ;; defaults to 139
  ;;(set-face-attribute 'default nil :font "Input Mono Narrow" :height 107)
  (set-face-attribute 'default nil :font "Fira Code" :height 119)
  )
...
(setq org-todo-keywords
      '(
        ...
        (sequence "IDEA(i)" "MAYBE(m)" "SOMEDAY(s)" ".." "PROJECT(p)" "|") ;; :EXPERIMENT: ..=someday
        (sequence "vision" "VISION(v)" "GOAL(g)" "FOCUS(f)" "MODE(o)" "|")
        (type "WEAKNESS(n)" "TECHNIQUE(q)" "HABIT(j)" "CHEATSHEET(a)" "RESOLUTION(r)")
        (type "BOOK(z)" "|")
        (type "~info" "|" "info(I)")
        (type "buy?" "buy~" "buy" "sell" "sell?" "sell~" "|" "bought" "sold")
        (type "~SKILL(k)" "|" "SKILL(K)")
        (type "~learn" "learn" "learn~" "learned")
        (type "~post" "post~" "post" "~message" "~comment" "|" "comment" "message" "post=")
        ...
        (sequence "!project" "project?" "project" "~project" "project~" "project," "project;" "|" "project=" "project." "project-")
        (type "~design" "~research" "design~" "research~" "trace" "|" "design" "research") ;; RESEARCH? :EXPERIMENT:
...
(with-eval-after-load 'org-agenda
  (setq org-agenda-custom-commands
        `(("c" . "Custom Agendas")
          ...
          ("cx" "All TODOs priority A|B groups by category" tags-todo "+PRIORITY={A\\|B}" ((org-super-agenda-groups '((:auto-category t)))))
