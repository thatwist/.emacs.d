...
(custom-set-faces '(dired-subtree-depth-1-face ((t (:background "#eeeeee")))))
(custom-set-faces '(dired-subtree-depth-2-face ((t (:background "#e8e8e8")))))
(custom-set-faces '(dired-subtree-depth-3-face ((t (:background "#e0e0e0")))))
(custom-set-faces '(dired-subtree-depth-4-face ((t (:background "#d8d8d8")))))
(custom-set-faces '(dired-subtree-depth-5-face ((t (:background "#d0d0d0")))))
(custom-set-faces '(dired-subtree-depth-6-face ((t (:background "#c8c8c8")))))
(custom-set-faces '(dired-subtree-depth-7-face ((t (:background "#c4c4c4")))))
(custom-set-faces '(dired-subtree-depth-8-face ((t (:background "#c0c0c0")))))
(custom-set-faces '(dired-subtree-depth-9-face ((t (:background "#bbbbbb")))))
(custom-set-faces '(dired-subtree-depth-10-face ((t (:background "#b8b8b8")))))
...
(custom-set-faces '(magit-diff-base-highlight ((t (:foreground "#8a8a01" :background "#f5f5db")))))
(custom-set-faces '(magit-diff-added-highlight ((t (:foreground "#118811" :background "#dcfedc")))))
(custom-set-faces '(magit-diff-removed-highlight ((t (:foreground "#881111" :background "#fedcdc")))))
...
(use-package bookmark
  :custom (bookmark-default-file "~/documents/org/bookmarks.eld"))
