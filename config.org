...
(custom-set-variables
  ...
  '(tab-bar-format '(tab-bar-format-history tab-bar-format-tabs-groups tab-bar-separator tab-bar-format-add-tab tab-bar-format-align-right tab-bar-format-global))
...
#+begin_src emacs-lisp
  ...
  (use-package org
    ...
    (defun my-org-confirm-babel-evaluate (lang body)
      (not (member lang '("emacs-lisp" "sql" "sh" "sqlite"))))
    :config
    (custom-set-variables
