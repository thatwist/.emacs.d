...
(with-eval-after-load 'dired
  (with-eval-after-load 'evil
    ...
    (evil-collection-define-key '(normal visual) 'dired-mode-map "." 'dired-hide-dotfiles-mode)
...
(with-eval-after-load 'evil 
  ...
  (evil-collection-define-key 'motion 'org-agenda-mode-map (kbd "<SPC>") 'evil-send-leader)
...
(with-eval-after-load 'evil
  ...
  (setq evil-snipe-disabled-modes '(ranger-mode dired-mode org-agenda-mode))
  (evil-snipe-mode 1)
