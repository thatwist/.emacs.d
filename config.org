...
(with-eval-after-load 'dired
  (with-eval-after-load 'evil
    ...
    (evil-collection-define-key 'normal 'dired-mode-map (kbd "f") 'dired-filter-map)
    ))
...
(with-eval-after-load 'evil
  ...
  (setq evil-snipe-disabled-modes '(emacs-lisp-mode ranger-mode dired-mode org-agenda-mode)))
