...
(custom-set-variables
 	'(desktop-modes-not-to-save '(tags-table-mode helpful-mode))
...
(use-package ivy-prescient
  ...
  :custom (ivy-prescient-sort-commands t))
...
#+begin_src emacs-lisp
  ...
  (use-package evil-collection
    ...
    (with-eval-after-load 'evil
      ...
      ;;;;;;;
      (load-library "ediff") ; some problem on init ediff-mode-map
      (load-library "ediff-util") ; some problem on init ediff-mode-map
      (require 'ediff-util) ; some problem on init ediff-mode-map
      (require 'ediff) ; some problem on init ediff-mode-map
...
(use-package windmove
  :ensure nil
  :defer 0.1 ;; use use-package hooks instead of below?
  :config 
  (windmove-install-defaults nil '(meta) ;; I don't use much these bindings, but they replicate i3 bindgins I have!
                             '((windmove-left h)
                               (windmove-right l)
                               (windmove-up k)
                               (windmove-down j)))
  (windmove-install-defaults nil '(meta shift)
                             '((windmove-swap-states-left h)
                               (windmove-swap-states-right l)
                               (windmove-swap-states-up k)
                               (windmove-swap-states-down j))))
...
(global-set-key [(shift control-i)] 'tab-rename)
...
(use-package evil-org
  ...
  (with-eval-after-load 'org
    (with-eval-after-load 'evil
      ...
      (customize-set-variable 'evil-org-key-theme '(navigation insert textobjects calendar)) ; no  'additional' - conflict with windmove
      (with-eval-after-load 'org-agenda
        (require 'evil-org-agenda)
        (evil-org-agenda-set-keys)
        (evil-define-key 'motion org-agenda-mode-map (kbd "M-k") nil) ;; free up for windmove
        (evil-define-key 'motion org-agenda-mode-map (kbd "M-j") nil) ;; free up for windmove
...
(with-eval-after-load 'org-agenda
  ...
  (add-hook 'org-agenda-mode-hook (lambda ()
                                    (define-key org-agenda-mode-map (kbd "s-,") 'hydra-org-agenda/body)
...
(use-package mu4e
  ...
  :demand t
  :commands (mu4e)
  :hook (after-init . (lambda () (mu4e-update-mail-and-index t)))
  :custom
