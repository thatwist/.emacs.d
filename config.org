...
(custom-set-faces '(default ((t (:background "#f8f7ef" :foreground "#101823")))))
...
(use-package elpy
  ...
  :config
  ;; disable annoying mouse selection toggling, no idea why this happens with python/elpy buffers
