...
(pretty-hydra-define utils-hydra
  ...
  ("Ivy"
   (("vv" ivy-push-view "push view")
    ("vc" ivy-switch-view "switch view")
    ("vV" ivy-pop-view "pop view"))
   "Emacs"
   ...
   (("ue" elfeed)
    ...
    ("uc" calculator)
    ("ut" google-translate-smooth-translate)
    ("up" pass)
    ("ui" password-store-insert)
    ("ue" password-store-edit)
