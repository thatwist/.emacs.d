...
(custom-set-faces '(font-lock-constant-face ((t :family "Source Code Pro"
                                                :background "#cff0ff"))))
...
(custom-set-faces '(font-lock-doc-face ((t (:slant italic
                                                   :family "Source Code Pro" :foreground "#888")))))
(custom-set-faces '(font-lock-comment-face ((t ( :slant italic :weight light
                                                 ;; :height 120
                                                 :width ultra-condensed :foreground "#666"
                                                 :family "Source Code Pro"
                                                 )))))
...
(custom-set-faces '(font-lock-function-name-face
                    ((t (:foreground "#64f" :background "#faf7dc")))))

(custom-set-faces '(avy-lead-face
                    ((t (:foreground "#fff" :background "#f5bbd0")))))

(custom-set-faces '(avy-lead-face-0
                    ((t (:foreground "#fff" :background "#afc7f9")))))

(custom-set-faces '(diredfl-dir-heading
                    ((t (:foreground "#0a0b3a" :background "#ffd7e0")))))

(custom-set-faces '(magit-diff-base-highlight
                    ((t (:foreground "#8a8a01" :background "#f5f5db")))))
