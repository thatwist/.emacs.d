...
(use-package god-mode
  ...
  :demand
  :general
  (:states 'normal :keymaps 'global-map "," 'god-execute-with-current-bindings))
#+end_src
...
(pretty-hydra-define toggle-hydra
 ...
 ("Basic"
  (("n" linum-mode "linum" :toggle t)
   ...
   ("D" auto-dim-other-buffers-mode "dim other" :toggle t)
   )
...
(use-package evil-org-agenda
  ...
  :general
  (:modes 'motion :keymaps 'org-agenda-mode-map
    "M-k" nil "M-j" nil  ;; free up for windmove
    "<SPC>" 'evil-send-leader ;; fix space
