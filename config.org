...
;; Enable ensure by default for use-package
  ;;use-package-always-ensure t ;; actually, there is a bug - when using this + ensure-nil, macro still generates code - when using byte-compilation there will be warnings
...
;; those whom I don't want to :demand above
(use-package emacs-defer
  :defer 0.5
  :custom
  ...
  (eval-after-load 'prog-mode
    (show-paren-mode 1))
  :hook ;; I have no idea why this gets on during init
...
(use-package tab-line
  ...
  (tab-line-tab-inactive ;; inactive tab
   ((t (:foreground "#fdf4c1" :background "#282828"))))
  (tab-line-tab ((t (:extend t :background "#504945" :foreground "#fdf4c1")))) ;; active tab in another window
  (tab-line ((t (:foreground "#fdf4c1" :background "#282828" :distant-foreground "gray20")))) ;; background behind tabs
  :custom
...
(use-package org-clock
  :preface (declare-function org-clocking-buffer "org-clock")
  :after org
  :init
...
(use-package mu4e
  ...
  (mu4e-get-mail-command "mbsync") ;; set it to "true" will not run mbsync within emacs
  ...
  (mu4e-update-interval 300) ;; update in background each 5min
