...
;;(load-file "/home/twist/.config/emacs/lisp/config.el")
...
(use-package gruvbox-theme
  ...
  (defun my/load-dark-theme ()
    (counsel-load-theme-action "gruvbox-dark-hard")
  ...
  (defun my/load-light-theme ()
    (counsel-load-theme-action "gruvbox-light-soft")
...
(use-package tab-line
  ...
  ("M-i" . kill-current-buffer) ;; don't have better binding left
