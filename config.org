...
#+begin_src emacs-lisp
  ...
  (use-package org
    :init (with-eval-after-load 'org (org-id-update-id-locations))
    :config
    (require 'org-install)
    (require 'org-expiry)
...
(use-package org-agenda
  ...
  :custom
  (org-agenda-files
    '("~/Dropbox/org/gcal/trading.org" "~/Dropbox/org/content.org" "~/Dropbox/org/goals.org"
...
(use-package tramp
  ...
  (setq tramp-default-method "ssh")
      :custom (tramp-syntax 'simplified)
)
