...
(use-package company
  ...
  ;; testing this one
  (add-to-list 'company-backends '(company-capf :with company-dabbrev :with company-yasnippet))
...
(use-package elpy
  ...
  (setq elpy-modeuls '(elpy-module-company elpy-module-eldoc
                                           ;;elpy-module-flymake
...
(let* ((file-name-handler-alist nil))
  ...
  (add-to-list 'load-path (concat user-emacs-directory "elpa/gruvbox-theme-1.30.1"))
  (require 'gruvbox-theme)
  (load-theme 'gruvbox-dark-hard t)


  (add-to-list 'load-path (concat user-emacs-directory "elpa/telephone-line-0.6"))
